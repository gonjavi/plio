...
import tictactoe2 from '../img/javascript/tictactoe2.png';
...
const dataProjects = [
  ...
  },
  {
    ...
    technologies: 'JavaScript - HTML - Materialize-CSS',
    titulo: 'TIC-TAC-TOE',
    description: 'A basic website with the Tic Tac Toe game based on javascript.',
    demoLink: 'https://rawcdn.githack.com/gonjavi/JavascriptTicTacToe/d5f9510bcf3fc82556eb058b68bed6151782bb65/index.html',
    githubLink: 'https://github.com/gonjavi/JavascriptTicTacToe',
    img: tictactoe2,
  },
  {
    id: 5,
