...
const dataProjects = [
  ...
  {
    id: 1,
    technologies: 'Ruby on Rails - RSpec - JavaScript',
    titulo: 'FACEBOOKAPP',
    description: 'A simple Facebook app with unit testing.',
  ...
  },
  {
    ...
    description: 'An sports tracking API with unit testing.',
  ...
  },
  {
    ...
    technologies: 'Ruby on Rails - RSpec',
    titulo: 'PRODUCTS API',
    description: 'An API for users with associations, and unit testing',
